...
@section('content')
    <div class="content_yield">
        {{ Form::open(['route'=>['class.update',$room->id],'method'=>'put','class' => 'col-md-12 row']) }}
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 row">
                <div class="row">
                    ...
                    <div class="form-group col-lg-3 col-md-3 col-sm-12">
                        ...
                        {{ Form::select('course_id', $courses,$room->course_id ,['class' => 'form-control','placeholder'=>"Chọn khóa học"]) }}
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6">
                        <div class="form-group col-md-6">
                            ...
                            {!! Form::date('start_date', $room->start_date, [
                            'class' => 'form-control',
                        ...
                        <div class="form-group col-md-6">
                            ...
                            {!! Form::date('end_date', $room->end_date, [
                            'class' => 'form-control',
                ...
                <div class="row">
                    <div class="form-group col-lg-12 col-md-12 col-sm-12">
                        ...
                        {!! Form::textArea('description', $room->description, [
                            'class' => 'form-control',
