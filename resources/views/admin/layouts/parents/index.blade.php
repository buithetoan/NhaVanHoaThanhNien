...
@section('content')
    <div class="content_yield">
        <div class="row">
            <h3 class="page_title">Phụ huynh</h3>
            <div class="col-md-12">
        ...
        <a href="{{ route('parent.store') }}" class="btn bg-color-green add_new_button"><i class="fas fa-plus"></i> Thêm mới</a>
            ...
            @foreach($parents as $key => $parent)
                <tr>
                    ...
                    <td class="text-center action_icon">
                        <a href="{{route('parent.edit',$parent->id)}}"><i class="far fa-edit edit"></i></a>
                        <a type="button" class="fas fa-trash-alt deletebutton text-danger btn" data-id="{{$parent->id}}" data-toggle="modal" data-target="#Modal"></a>
                    </td>
                </tr>
            @endforeach
            <!-- End loop -->
    ...
    {{Form::open(['route' => ['parent.delete'], 'method' => 'DELETE'])}}
