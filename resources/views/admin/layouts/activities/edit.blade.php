...
@section('content')
    <div class="content_yield">
        {{ Form::open(['route'=>['active.update',$active->id],'method'=>'put','enctype '=>'multipart/form-data','class' => 'col-md-12 row']) }}
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 row">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        {!! Form::date('start_date', $active->start_date, [
                        'class' => 'form-control',
                    ...
                    <div class="form-group col-md-6">
                        ...
                        {!! Form::date('end_date', $active->end_date, [
                        'class' => 'form-control',
